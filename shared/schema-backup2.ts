...
const urlShortenerEndpoints: ApiEndpoint[] = [
  { path: "/api/short/tinyurl", method: "GET", description: "Shorten URL with TinyURL", params: [{ name: "url", type: "string", required: true, description: "The URL to shorten", default: "https://apis.megan.qzz.io" }], format: "json", category: "urlshortener", provider: "TinyURL" },
  { path: "/api/short/isgd", method: "GET", description: "Shorten URL with is.gd", params: [{ name: "url", type: "string", required: true, description: "The URL to shorten", default: "https://apis.megan.qzz.io" }], format: "json", category: "urlshortener", provider: "is.gd" },
  { path: "/api/short/vgd", method: "GET", description: "Shorten URL with v.gd", params: [{ name: "url", type: "string", required: true, description: "The URL to shorten", default: "https://apis.megan.qzz.io" }], format: "json", category: "urlshortener", provider: "v.gd" },
  { path: "/api/short/cleanuri", method: "GET", description: "Shorten URL with CleanURI", params: [{ name: "url", type: "string", required: true, description: "The URL to shorten", default: "https://apis.megan.qzz.io" }], format: "json", category: "urlshortener", provider: "CleanURI" },
  { path: "/api/short/chilpit", method: "GET", description: "Shorten URL with Chilp.it", params: [{ name: "url", type: "string", required: true, description: "The URL to shorten", default: "https://apis.megan.qzz.io" }], format: "json", category: "urlshortener", provider: "Chilp.it" },
  { path: "/api/short/clckru", method: "GET", description: "Shorten URL with clck.ru", params: [{ name: "url", type: "string", required: true, description: "The URL to shorten", default: "https://apis.megan.qzz.io" }], format: "json", category: "urlshortener", provider: "clck.ru" },
  { path: "/api/short/dagd", method: "GET", description: "Shorten URL with da.gd", params: [{ name: "url", type: "string", required: true, description: "The URL to shorten", default: "https://apis.megan.qzz.io" }], format: "json", category: "urlshortener", provider: "da.gd" },
...
const toolsEndpoints: ApiEndpoint[] = [
  ...
  { path: "/api/tools/screenshot", method: "GET", description: "Take website screenshot", params: [{ name: "url", type: "string", required: true, description: "URL to screenshot", default: "https://apis.megan.qzz.io" }], format: "json", category: "tools", provider: "thum.io" },
...
const securityEndpoints: ApiEndpoint[] = [
  { path: "/api/security/whois", method: "GET", description: "WHOIS domain lookup", params: [{ name: "domain", type: "string", required: true, description: "Domain to lookup", default: "apis.megan.qzz.io" }], format: "json", category: "security", provider: "RDAP" },
  { path: "/api/security/dns", method: "GET", description: "DNS records lookup (A, AAAA, MX, TXT, NS, CNAME)", params: [{ name: "domain", type: "string", required: true, description: "Domain to lookup", default: "apis.megan.qzz.io" }], format: "json", category: "security" },
  { path: "/api/security/subdomain", method: "GET", description: "Scan for common subdomains", params: [{ name: "domain", type: "string", required: true, description: "Domain to scan", default: "apis.megan.qzz.io" }], format: "json", category: "security" },
  ...
  { path: "/api/security/portscan", method: "GET", description: "Scan common ports on a host", params: [{ name: "host", type: "string", required: true, description: "Hostname or IP", default: "apis.megan.qzz.io" }], format: "json", category: "security" },
  { path: "/api/security/headers", method: "GET", description: "Fetch HTTP response headers", params: [{ name: "url", type: "string", required: true, description: "URL to check", default: "https://apis.megan.qzz.io" }], format: "json", category: "security" },
  { path: "/api/security/ssl", method: "GET", description: "Check SSL certificate details", params: [{ name: "host", type: "string", required: true, description: "Hostname to check", default: "apis.megan.qzz.io" }], format: "json", category: "security" },
  { path: "/api/security/tls", method: "GET", description: "Get TLS connection details", params: [{ name: "host", type: "string", required: true, description: "Hostname to check", default: "apis.megan.qzz.io" }], format: "json", category: "security" },
  { path: "/api/security/ping", method: "GET", description: "Ping a host and check latency", params: [{ name: "host", type: "string", required: true, description: "Hostname to ping", default: "apis.megan.qzz.io" }], format: "json", category: "security" },
  { path: "/api/security/latency", method: "GET", description: "Measure HTTP latency", params: [{ name: "url", type: "string", required: true, description: "URL to test", default: "https://apis.megan.qzz.io" }], format: "json", category: "security" },
  { path: "/api/security/traceroute", method: "GET", description: "Trace route to host", params: [{ name: "host", type: "string", required: true, description: "Hostname to trace", default: "apis.megan.qzz.io" }], format: "json", category: "security" },
  ...
  { path: "/api/security/security-headers", method: "GET", description: "Analyze security headers with scoring", params: [{ name: "url", type: "string", required: true, description: "URL to analyze", default: "https://apis.megan.qzz.io" }], format: "json", category: "security" },
  { path: "/api/security/waf", method: "GET", description: "Detect Web Application Firewall", params: [{ name: "url", type: "string", required: true, description: "URL to check", default: "https://apis.megan.qzz.io" }], format: "json", category: "security" },
  { path: "/api/security/firewall", method: "GET", description: "Check firewall and security headers", params: [{ name: "host", type: "string", required: true, description: "Hostname to check", default: "apis.megan.qzz.io" }], format: "json", category: "security" },
  { path: "/api/security/robots", method: "GET", description: "Check robots.txt file", params: [{ name: "url", type: "string", required: true, description: "Website URL", default: "https://apis.megan.qzz.io" }], format: "json", category: "security" },
  { path: "/api/security/sitemap", method: "GET", description: "Check sitemap.xml", params: [{ name: "url", type: "string", required: true, description: "Website URL", default: "https://apis.megan.qzz.io" }], format: "json", category: "security" },
  { path: "/api/security/cms", method: "GET", description: "Detect CMS/platform", params: [{ name: "url", type: "string", required: true, description: "Website URL", default: "https://apis.megan.qzz.io" }], format: "json", category: "security" },
  { path: "/api/security/techstack", method: "GET", description: "Detect technology stack", params: [{ name: "url", type: "string", required: true, description: "Website URL", default: "https://apis.megan.qzz.io" }], format: "json", category: "security" },
  { path: "/api/security/cookies", method: "GET", description: "Scan cookies for security flags", params: [{ name: "url", type: "string", required: true, description: "Website URL", default: "https://apis.megan.qzz.io" }], format: "json", category: "security" },
  { path: "/api/security/redirects", method: "GET", description: "Check redirect chain", params: [{ name: "url", type: "string", required: true, description: "URL to check", default: "https://apis.megan.qzz.io" }], format: "json", category: "security" },
  { path: "/api/security/xss", method: "GET", description: "Check XSS protection headers", params: [{ name: "url", type: "string", required: true, description: "URL to check", default: "https://apis.megan.qzz.io" }], format: "json", category: "security" },
  { path: "/api/security/sqli", method: "GET", description: "Check SQL injection protection", params: [{ name: "url", type: "string", required: true, description: "URL to check", default: "https://apis.megan.qzz.io" }], format: "json", category: "security" },
  { path: "/api/security/csrf", method: "GET", description: "Check CSRF protection", params: [{ name: "url", type: "string", required: true, description: "URL to check", default: "https://apis.megan.qzz.io" }], format: "json", category: "security" },
  { path: "/api/security/clickjack", method: "GET", description: "Check clickjacking protection", params: [{ name: "url", type: "string", required: true, description: "URL to check", default: "https://apis.megan.qzz.io" }], format: "json", category: "security" },
  { path: "/api/security/directory", method: "GET", description: "Scan for exposed directories", params: [{ name: "url", type: "string", required: true, description: "Website URL", default: "https://apis.megan.qzz.io" }], format: "json", category: "security" },
  { path: "/api/security/exposed-files", method: "GET", description: "Check for exposed sensitive files", params: [{ name: "url", type: "string", required: true, description: "Website URL", default: "https://apis.megan.qzz.io" }], format: "json", category: "security" },
  { path: "/api/security/misconfig", method: "GET", description: "Check security misconfigurations", params: [{ name: "url", type: "string", required: true, description: "Website URL", default: "https://apis.megan.qzz.io" }], format: "json", category: "security" },
  ...
  { path: "/api/security/openports", method: "GET", description: "Scan extended port range", params: [{ name: "host", type: "string", required: true, description: "Hostname or IP", default: "apis.megan.qzz.io" }], format: "json", category: "security" },
  ...
  { path: "/api/security/url-scan", method: "GET", description: "Full URL security scan", params: [{ name: "url", type: "string", required: true, description: "URL to scan", default: "https://apis.megan.qzz.io" }], format: "json", category: "security" },
  { path: "/api/security/phish", method: "GET", description: "Check URL for phishing indicators", params: [{ name: "url", type: "string", required: true, description: "URL to check", default: "https://apis.megan.qzz.io" }], format: "json", category: "security" },
  { path: "/api/security/metadata", method: "GET", description: "Extract website metadata", params: [{ name: "url", type: "string", required: true, description: "Website URL", default: "https://apis.megan.qzz.io" }], format: "json", category: "security" },
];
