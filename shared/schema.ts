  ...
  },
  {
    ...
    subcategories: [
      ...
      },
      {
        id: "waifu",
        name: "Waifu.im",
        description: "High-quality waifu images with tags, artist info, and metadata. Filter by tag, get multiple images, or browse NSFW content.",
        categoryId: "fun",
...
const socialMediaEndpoints: ApiEndpoint[] = [
  ...
  createEndpoint("/api/v2/download/twitter", "GET", "Download Twitter/X video in multiple MP4 qualities (576p, 360p, 270p).", [{ name: "url", type: "string", required: true, description: "Twitter/X post URL", default: "https://x.com/BrianMPeter/status/2099755238647271483" }], "json", "media-downloader", "social-media", "v2", "2026-09-16T10:00:00.000Z", "yt-dlp", [SC.SUCCESS, SC.BAD_REQUEST, SC.SERVER_ERROR], 20),
  createEndpoint("/api/v2/download/twitter-audio", "GET", "Extract audio from Twitter/X video as M4A (128kbps).", [{ name: "url", type: "string", required: true, description: "Twitter/X post URL", default: "https://x.com/BrianMPeter/status/2099755238647271483" }], "json", "media-downloader", "social-media", "v2", "2026-09-16T10:00:00.000Z", "yt-dlp", [SC.SUCCESS, SC.BAD_REQUEST, SC.SERVER_ERROR], 20),
  createEndpoint("/api/v2/download/ytaudio", "GET", "Download YouTube audio directly from yt-dlp (googlevideo). Works with URL or search query.", [
    { name: "q", type: "string", required: true, description: "YouTube URL or search query", default: "Joeboy - Body and Soul" }
  ], "json", "media-downloader", "youtube", "v2", "2026-09-17T10:00:00.000Z", "yt-dlp", [SC.SUCCESS, SC.BAD_REQUEST, SC.NOT_FOUND, SC.SERVER_ERROR], 20),
  createEndpoint("/api/v2/download/ytaudio/proxy", "GET", "Proxy YouTube audio from googlevideo (works from any IP).", [
    { name: "url", type: "string", required: true, description: "Direct googlevideo audio URL", default: "https://rr3---sn-xxx.googlevideo.com/videoplayback?..." }
  ], "json", "media-downloader", "youtube", "v2", "2026-09-17T10:00:00.000Z", "yt-dlp", [SC.SUCCESS, SC.BAD_REQUEST, SC.SERVER_ERROR], 60),
...
const networkSecurityEndpoints: ApiEndpoint[] = [
  createEndpoint("/api/security/whois", "GET", "WHOIS domain lookup - get domain registration, registrar, and expiry information.", [{ name: "domain", type: "string", required: true, description: "Domain to lookup", default: "apis.megan.qzz.io" }], "json", "security", "network-security", "v0", "2025-11-20T10:00:00.000Z", "RDAP", [SC.SUCCESS, SC.BAD_REQUEST, SC.SERVER_ERROR], 60),
  createEndpoint("/api/security/dns", "GET", "DNS records lookup - A, AAAA, MX, TXT, NS, and CNAME records.", [{ name: "domain", type: "string", required: true, description: "Domain to lookup", default: "apis.megan.qzz.io" }], "json", "security", "network-security", "v0", "2025-11-20T10:00:00.000Z", "DNS", [SC.SUCCESS, SC.BAD_REQUEST, SC.SERVER_ERROR], 60),
  createEndpoint("/api/security/subdomain", "GET", "Scan for common subdomains on a target domain.", [{ name: "domain", type: "string", required: true, description: "Domain to scan", default: "apis.megan.qzz.io" }], "json", "security", "network-security", "v0", "2025-11-22T11:00:00.000Z", "Multi-source", [SC.SUCCESS, SC.BAD_REQUEST, SC.SERVER_ERROR], 30),
  ...
  createEndpoint("/api/security/portscan", "GET", "Scan common ports on a host to identify open services.", [{ name: "host", type: "string", required: true, description: "Hostname or IP", default: "apis.megan.qzz.io" }], "json", "security", "network-security", "v0", "2025-11-25T09:00:00.000Z", "Multi-source", [SC.SUCCESS, SC.BAD_REQUEST, SC.SERVER_ERROR], 20),
  createEndpoint("/api/security/headers", "GET", "Fetch HTTP response headers from a target URL.", [{ name: "url", type: "string", required: true, description: "URL to check", default: "https://apis.megan.qzz.io" }], "json", "security", "network-security", "v0", "2025-11-28T10:00:00.000Z", "HTTP", [SC.SUCCESS, SC.BAD_REQUEST, SC.SERVER_ERROR], 60),
  createEndpoint("/api/security/ssl", "GET", "Check SSL certificate details - issuer, expiry, and validity.", [{ name: "host", type: "string", required: true, description: "Hostname to check", default: "apis.megan.qzz.io" }], "json", "security", "network-security", "v0", "2025-11-28T10:00:00.000Z", "SSL", [SC.SUCCESS, SC.BAD_REQUEST, SC.SERVER_ERROR], 60),
  createEndpoint("/api/security/tls", "GET", "Get TLS connection details - version, cipher, and security.", [{ name: "host", type: "string", required: true, description: "Hostname to check", default: "apis.megan.qzz.io" }], "json", "security", "network-security", "v0", "2025-12-01T11:00:00.000Z", "TLS", [SC.SUCCESS, SC.BAD_REQUEST, SC.SERVER_ERROR], 60),
  createEndpoint("/api/security/ping", "GET", "Ping a host and check latency and availability.", [{ name: "host", type: "string", required: true, description: "Hostname to ping", default: "apis.megan.qzz.io" }], "json", "security", "network-security", "v0", "2025-12-01T11:00:00.000Z", "ICMP", [SC.SUCCESS, SC.BAD_REQUEST, SC.SERVER_ERROR], 60),
  createEndpoint("/api/security/latency", "GET", "Measure HTTP latency to a target URL.", [{ name: "url", type: "string", required: true, description: "URL to test", default: "https://apis.megan.qzz.io" }], "json", "security", "network-security", "v0", "2025-12-03T09:00:00.000Z", "HTTP", [SC.SUCCESS, SC.BAD_REQUEST, SC.SERVER_ERROR], 60),
  createEndpoint("/api/security/traceroute", "GET", "Trace route to a host showing network path and hops.", [{ name: "host", type: "string", required: true, description: "Hostname to trace", default: "apis.megan.qzz.io" }], "json", "security", "network-security", "v0", "2025-12-03T09:00:00.000Z", "Traceroute", [SC.SUCCESS, SC.BAD_REQUEST, SC.SERVER_ERROR], 20),
  ...
  createEndpoint("/api/security/openports", "GET", "Scan extended port range on a target host.", [{ name: "host", type: "string", required: true, description: "Hostname or IP", default: "apis.megan.qzz.io" }], "json", "security", "network-security", "v0", "2025-12-08T11:00:00.000Z", "Multi-source", [SC.SUCCESS, SC.BAD_REQUEST, SC.SERVER_ERROR], 20),
...
const webSecurityEndpoints: ApiEndpoint[] = [
  createEndpoint("/api/security/security-headers", "GET", "Analyze security headers with scoring - checks HSTS, CSP, X-Frame-Options, and more.", [{ name: "url", type: "string", required: true, description: "URL to analyze", default: "https://apis.megan.qzz.io" }], "json", "security", "web-security", "v0", "2025-12-10T11:00:00.000Z", "SecurityHeaders", [SC.SUCCESS, SC.BAD_REQUEST, SC.SERVER_ERROR], 60),
  createEndpoint("/api/security/waf", "GET", "Detect Web Application Firewall on a target URL.", [{ name: "url", type: "string", required: true, description: "URL to check", default: "https://apis.megan.qzz.io" }], "json", "security", "web-security", "v0", "2025-12-10T11:00:00.000Z", "WAF Detector", [SC.SUCCESS, SC.BAD_REQUEST, SC.SERVER_ERROR], 60),
  createEndpoint("/api/security/firewall", "GET", "Check firewall and security headers on a target host.", [{ name: "host", type: "string", required: true, description: "Hostname to check", default: "apis.megan.qzz.io" }], "json", "security", "web-security", "v0", "2025-12-12T09:00:00.000Z", "Multi-source", [SC.SUCCESS, SC.BAD_REQUEST, SC.SERVER_ERROR], 60),
  createEndpoint("/api/security/robots", "GET", "Check robots.txt file for a website.", [{ name: "url", type: "string", required: true, description: "Website URL", default: "https://apis.megan.qzz.io" }], "json", "security", "web-security", "v0", "2025-12-12T09:00:00.000Z", "HTTP", [SC.SUCCESS, SC.BAD_REQUEST, SC.SERVER_ERROR], 60),
  createEndpoint("/api/security/sitemap", "GET", "Check sitemap.xml for a website.", [{ name: "url", type: "string", required: true, description: "Website URL", default: "https://apis.megan.qzz.io" }], "json", "security", "web-security", "v0", "2025-12-15T10:00:00.000Z", "HTTP", [SC.SUCCESS, SC.BAD_REQUEST, SC.SERVER_ERROR], 60),
  createEndpoint("/api/security/cms", "GET", "Detect CMS/platform used by a website.", [{ name: "url", type: "string", required: true, description: "Website URL", default: "https://apis.megan.qzz.io" }], "json", "security", "web-security", "v0", "2025-12-15T10:00:00.000Z", "CMS Detector", [SC.SUCCESS, SC.BAD_REQUEST, SC.SERVER_ERROR], 60),
  createEndpoint("/api/security/techstack", "GET", "Detect technology stack used by a website.", [{ name: "url", type: "string", required: true, description: "Website URL", default: "https://apis.megan.qzz.io" }], "json", "security", "web-security", "v0", "2025-12-18T11:00:00.000Z", "Tech Detector", [SC.SUCCESS, SC.BAD_REQUEST, SC.SERVER_ERROR], 60),
  createEndpoint("/api/security/cookies", "GET", "Scan cookies for security flags - Secure, HttpOnly, SameSite.", [{ name: "url", type: "string", required: true, description: "Website URL", default: "https://apis.megan.qzz.io" }], "json", "security", "web-security", "v0", "2025-12-18T11:00:00.000Z", "Cookie Scanner", [SC.SUCCESS, SC.BAD_REQUEST, SC.SERVER_ERROR], 60),
  createEndpoint("/api/security/redirects", "GET", "Check redirect chain for a URL.", [{ name: "url", type: "string", required: true, description: "URL to check", default: "https://apis.megan.qzz.io" }], "json", "security", "web-security", "v0", "2025-12-20T09:00:00.000Z", "HTTP", [SC.SUCCESS, SC.BAD_REQUEST, SC.SERVER_ERROR], 60),
  createEndpoint("/api/security/xss", "GET", "Check XSS protection headers on a target URL.", [{ name: "url", type: "string", required: true, description: "URL to check", default: "https://apis.megan.qzz.io" }], "json", "security", "web-security", "v0", "2025-12-20T09:00:00.000Z", "Security Scanner", [SC.SUCCESS, SC.BAD_REQUEST, SC.SERVER_ERROR], 60),
  createEndpoint("/api/security/sqli", "GET", "Check SQL injection protection on a target URL.", [{ name: "url", type: "string", required: true, description: "URL to check", default: "https://apis.megan.qzz.io" }], "json", "security", "web-security", "v0", "2025-12-22T10:00:00.000Z", "Security Scanner", [SC.SUCCESS, SC.BAD_REQUEST, SC.SERVER_ERROR], 60),
  createEndpoint("/api/security/csrf", "GET", "Check CSRF protection on a target URL.", [{ name: "url", type: "string", required: true, description: "URL to check", default: "https://apis.megan.qzz.io" }], "json", "security", "web-security", "v0", "2025-12-22T10:00:00.000Z", "Security Scanner", [SC.SUCCESS, SC.BAD_REQUEST, SC.SERVER_ERROR], 60),
  createEndpoint("/api/security/clickjack", "GET", "Check clickjacking protection on a target URL.", [{ name: "url", type: "string", required: true, description: "URL to check", default: "https://apis.megan.qzz.io" }], "json", "security", "web-security", "v0", "2025-12-25T11:00:00.000Z", "Security Scanner", [SC.SUCCESS, SC.BAD_REQUEST, SC.SERVER_ERROR], 60),
  createEndpoint("/api/security/directory", "GET", "Scan for exposed directories on a website.", [{ name: "url", type: "string", required: true, description: "Website URL", default: "https://apis.megan.qzz.io" }], "json", "security", "web-security", "v0", "2025-12-25T11:00:00.000Z", "Directory Scanner", [SC.SUCCESS, SC.BAD_REQUEST, SC.SERVER_ERROR], 30),
  createEndpoint("/api/security/exposed-files", "GET", "Check for exposed sensitive files on a website.", [{ name: "url", type: "string", required: true, description: "Website URL", default: "https://apis.megan.qzz.io" }], "json", "security", "web-security", "v0", "2025-12-28T09:00:00.000Z", "File Scanner", [SC.SUCCESS, SC.BAD_REQUEST, SC.SERVER_ERROR], 30),
  createEndpoint("/api/security/misconfig", "GET", "Check security misconfigurations on a website.", [{ name: "url", type: "string", required: true, description: "Website URL", default: "https://apis.megan.qzz.io" }], "json", "security", "web-security", "v0", "2025-12-28T09:00:00.000Z", "Security Scanner", [SC.SUCCESS, SC.BAD_REQUEST, SC.SERVER_ERROR], 60),
  createEndpoint("/api/security/url-scan", "GET", "Full URL security scan - checks headers, SSL, and vulnerabilities.", [{ name: "url", type: "string", required: true, description: "URL to scan", default: "https://apis.megan.qzz.io" }], "json", "security", "web-security", "v0", "2026-01-05T10:00:00.000Z", "Multi-scanner", [SC.SUCCESS, SC.BAD_REQUEST, SC.SERVER_ERROR], 30),
  createEndpoint("/api/security/phish", "GET", "Check URL for phishing indicators and suspicious patterns.", [{ name: "url", type: "string", required: true, description: "URL to check", default: "https://apis.megan.qzz.io" }], "json", "security", "web-security", "v0", "2026-01-05T10:00:00.000Z", "Phish Detector", [SC.SUCCESS, SC.BAD_REQUEST, SC.SERVER_ERROR], 60),
  createEndpoint("/api/security/metadata", "GET", "Extract website metadata - title, description, OG tags, and more.", [{ name: "url", type: "string", required: true, description: "Website URL", default: "https://apis.megan.qzz.io" }], "json", "security", "web-security", "v0", "2026-01-08T11:00:00.000Z", "Metadata Extractor", [SC.SUCCESS, SC.BAD_REQUEST, SC.SERVER_ERROR], 60),
];
...
const textToolsEndpoints: ApiEndpoint[] = [
  createEndpoint("/api/tools/qrcode", "GET", "Generate QR code image from text or URL.", [
    { name: "text", type: "string", required: true, description: "Text or URL to encode", default: "https://apis.megan.qzz.io" },
  ...
  createEndpoint("/api/tools/screenshot", "GET", "Take website screenshot and get image URL.", [{ name: "url", type: "string", required: true, description: "URL to screenshot", default: "https://apis.megan.qzz.io" }], "json", "tools", "text-tools", "v0", "2025-11-10T09:00:00.000Z", "thum.io", [SC.SUCCESS, SC.BAD_REQUEST, SC.SERVER_ERROR], 30),
...
const animeEndpoints: ApiEndpoint[] = [
  ...
  createEndpoint("/api/anime/waifu/random", "GET", "Get random SFW waifu image from Waifu.im with tags, artists, and metadata.", [], "json", "anime", "waifu", "v1", "2026-08-21T12:00:00.000Z", "Waifu.im", [SC.SUCCESS, SC.SERVER_ERROR], 60),
  createEndpoint("/api/anime/waifu/search", "GET", "Search waifu images by tag (waifu, maid, oppai, etc).", [{ name: "tag", type: "string", required: true, description: "Tag to filter by", default: "waifu" }], "json", "anime", "waifu", "v1", "2026-08-21T12:00:00.000Z", "Waifu.im", [SC.SUCCESS, SC.BAD_REQUEST, SC.SERVER_ERROR], 60),
  createEndpoint("/api/anime/waifu/tags", "GET", "List all available waifu tags with descriptions and counts.", [], "json", "anime", "waifu", "v1", "2026-08-21T12:00:00.000Z", "Waifu.im", [SC.SUCCESS, SC.SERVER_ERROR], 60),
  createEndpoint("/api/anime/waifu/multiple", "GET", "Get multiple waifu images at once (up to 30).", [{ name: "n", type: "number", required: false, description: "Number of images (default 10, max 30)", default: "10" }, { name: "tag", type: "string", required: false, description: "Optional tag filter", default: "waifu" }], "json", "anime", "waifu", "v1", "2026-08-21T12:00:00.000Z", "Waifu.im", [SC.SUCCESS, SC.SERVER_ERROR], 30),
  createEndpoint("/api/anime/waifu/nsfw", "GET", "Get NSFW waifu image (explicit content, use with caution).", [], "json", "anime", "waifu", "v1", "2026-08-21T12:00:00.000Z", "Waifu.im", [SC.SUCCESS, SC.SERVER_ERROR], 30),
];
...
const urlShortenerEndpoints: ApiEndpoint[] = [
  createEndpoint("/api/short/tinyurl", "GET", "Shorten URL with TinyURL.", [{ name: "url", type: "string", required: true, description: "URL to shorten", default: "https://apis.megan.qzz.io" }], "json", "url", "url-shortener", "v0", "2025-11-10T10:00:00.000Z", "TinyURL", [SC.SUCCESS, SC.BAD_REQUEST, SC.SERVER_ERROR], 60),
  createEndpoint("/api/short/isgd", "GET", "Shorten URL with is.gd.", [{ name: "url", type: "string", required: true, description: "URL to shorten", default: "https://apis.megan.qzz.io" }], "json", "url", "url-shortener", "v0", "2025-11-10T10:00:00.000Z", "is.gd", [SC.SUCCESS, SC.BAD_REQUEST, SC.SERVER_ERROR], 60),
  createEndpoint("/api/short/vgd", "GET", "Shorten URL with v.gd.", [{ name: "url", type: "string", required: true, description: "URL to shorten", default: "https://apis.megan.qzz.io" }], "json", "url", "url-shortener", "v0", "2025-11-12T09:00:00.000Z", "v.gd", [SC.SUCCESS, SC.BAD_REQUEST, SC.SERVER_ERROR], 60),
  createEndpoint("/api/short/cleanuri", "GET", "Shorten URL with CleanURI.", [{ name: "url", type: "string", required: true, description: "URL to shorten", default: "https://apis.megan.qzz.io" }], "json", "url", "url-shortener", "v0", "2025-11-12T09:00:00.000Z", "CleanURI", [SC.SUCCESS, SC.BAD_REQUEST, SC.SERVER_ERROR], 60),
  createEndpoint("/api/short/chilpit", "GET", "Shorten URL with Chilp.it.", [{ name: "url", type: "string", required: true, description: "URL to shorten", default: "https://apis.megan.qzz.io" }], "json", "url", "url-shortener", "v0", "2025-11-15T10:00:00.000Z", "Chilp.it", [SC.SUCCESS, SC.BAD_REQUEST, SC.SERVER_ERROR], 60),
  createEndpoint("/api/short/clckru", "GET", "Shorten URL with clck.ru.", [{ name: "url", type: "string", required: true, description: "URL to shorten", default: "https://apis.megan.qzz.io" }], "json", "url", "url-shortener", "v0", "2025-11-15T10:00:00.000Z", "clck.ru", [SC.SUCCESS, SC.BAD_REQUEST, SC.SERVER_ERROR], 60),
  createEndpoint("/api/short/dagd", "GET", "Shorten URL with da.gd.", [{ name: "url", type: "string", required: true, description: "URL to shorten", default: "https://apis.megan.qzz.io" }], "json", "url", "url-shortener", "v0", "2025-11-18T11:00:00.000Z", "da.gd", [SC.SUCCESS, SC.BAD_REQUEST, SC.SERVER_ERROR], 60),
