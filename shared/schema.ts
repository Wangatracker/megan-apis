...
const newWorkingAIModels: ApiEndpoint[] = [
  ...
  { path: "/api/v1/ai/image/magicstudio", method: "GET", description: "Generate AI art using MagicStudio (no key required)", params: [{ name: "prompt", type: "string", required: true, description: "Image prompt", default: "a cute cat" }], format: "json", category: "ai-image", provider: "MagicStudio" },
];

const mediaStreamingEndpoints: ApiEndpoint[] = [
  { path: "/api/v1/seegore/home", method: "GET", description: "Get latest videos from SeeGore with direct MP4 links", params: [], format: "json", category: "media", provider: "SeeGore" },
  { path: "/api/v1/seegore/search", method: "GET", description: "Search SeeGore videos by keyword", params: [{ name: "q", type: "string", required: true, description: "Search query", default: "accident" }], format: "json", category: "media", provider: "SeeGore" },
  { path: "/api/v1/seegore/watch", method: "GET", description: "Get direct MP4 video URL from SeeGore", params: [{ name: "url", type: "string", required: true, description: "Video URL or slug", default: "https://seegore.com/video-slug/" }], format: "json", category: "media", provider: "SeeGore" },
  { path: "/api/v1/movie/home", method: "GET", description: "Get latest movies from LK21 with streaming and download links", params: [], format: "json", category: "media", provider: "LK21" },
  { path: "/api/v1/movie/detail", method: "GET", description: "Get movie details, download links, and streaming players", params: [{ name: "url", type: "string", required: true, description: "Movie URL", default: "https://tv10.lk21official.cc/movie-slug/" }], format: "json", category: "media", provider: "LK21" },
  { path: "/api/v1/movie/stream", method: "GET", description: "Get streaming players for a movie", params: [{ name: "url", type: "string", required: true, description: "Movie URL", default: "https://tv10.lk21official.cc/movie-slug/" }], format: "json", category: "media", provider: "LK21" },
  { path: "/api/v1/tokusatsu/home", method: "GET", description: "Get latest Kamen Rider, Super Sentai, and Ultraman episodes", params: [], format: "json", category: "media", provider: "TokusatsuIndo" },
  { path: "/api/v1/tokusatsu/search", method: "GET", description: "Search tokusatsu episodes (Kamen Rider, Super Sentai, Ultraman)", params: [{ name: "q", type: "string", required: true, description: "Search query", default: "kamen rider" }], format: "json", category: "media", provider: "TokusatsuIndo" },
  { path: "/api/v1/tokusatsu/watch", method: "GET", description: "Get streaming URL for a tokusatsu episode", params: [{ name: "url", type: "string", required: true, description: "Episode URL", default: "https://www.tokusatsuindo.com/episode-slug/" }], format: "json", category: "media", provider: "TokusatsuIndo" },
];
